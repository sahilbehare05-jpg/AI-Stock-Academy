...
export default function AcademyLesson() {
  ...
  /*
   * Decide which visual should be shown
   * based on the lesson title.
   */
  const getVisualType = () => {
      ...
      return (
        <div className="rounded-2xl border border-white/10 bg-slate-950/60 p-5 lg:p-7">
          ...
          <p className="text-xs text-slate-500 mb-6">
            A candlestick shows the Open, High, Low and Close prices for a period.
          </p>
          ...
          <div className="relative h-72 rounded-xl border border-white/10 bg-slate-950 overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center gap-7">
              {[
                { body: 'h-16', wick: 'h-28', bullish: false },
                { body: 'h-24', wick: 'h-36', bullish: true },
                { body: 'h-12', wick: 'h-24', bullish: false },
                { body: 'h-28', wick: 'h-40', bullish: true },
                { body: 'h-20', wick: 'h-32', bullish: true },
                { body: 'h-10', wick: 'h-24', bullish: false },
                { body: 'h-32', wick: 'h-44', bullish: true },
              ].map((candle, index) => (
                <div
                  key={index}
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-950/60 p-5 lg:p-7">
          ...
          <div className="mt-5 rounded-xl bg-white/5 border border-white/10 p-4">
            <p className="text-xs text-slate-400">
              ...
              Trends describe the general direction of price movement.
              Short-term movements can move against the broader trend.
            </p>
          </div>
        </div>
      )
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Great job. Your Academy progress has been
                    updated.
                  </p>
                </div>
              </div>
